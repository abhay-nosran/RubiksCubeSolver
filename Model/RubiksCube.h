...
public :
    ...
    string getColorStrip(uint8_t index) ;
    uint8_t getCornerIndex(uint8_t index) ;
    uint8_t getCornerOrientation(uint8_t index) ;
   ...
   vector<MOVE> randomShuffle(int times);
    ...
    // fucntion to generate rubiks cube from the given input string
};
